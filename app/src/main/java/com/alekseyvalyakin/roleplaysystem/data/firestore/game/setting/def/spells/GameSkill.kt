package com.alekseyvalyakin.roleplaysystem.data.firestore.game.setting.def.spells
...
interface GameSpell : FireStoreIdModel, Selectable {
    @Exclude
    ...
    enum class INFO(val id: String) {
        ...
        companion object {
            ...
            fun isSupported(item: GameSpell): Boolean {
