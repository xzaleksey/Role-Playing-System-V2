...
import com.alekseyvalyakin.roleplaysystem.data.donate.DonateInteractorImpl
...
class MainBuilder(dependency: ParentComponent) : BaseViewBuilder<MainView, MainBuilder.ParentComponent>(dependency) {
    ...
    abstract class Module {
        ...
        companion object {
            ...
            @Provides
            @JvmStatic
            internal fun donateInteractor(mainActivity: MainActivity): DonateInteractor {
                return DonateInteractorImpl(mainActivity)
            }
        }
