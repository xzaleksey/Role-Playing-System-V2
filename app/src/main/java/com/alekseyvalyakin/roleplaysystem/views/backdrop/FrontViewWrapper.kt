...
class FrontViewWrapper(context: Context,
                       private val frontViewContainer: FrontViewContainer,
    ...
    init {
        ...
        clipToOutline = true
        elevation = getCommonDimen().toFloat()
        outlineProvider = object : ViewOutlineProvider() {
            override fun getOutline(view: View, outline: Outline) {
                outline.setRoundRect(0, 0, view.width, (view.height + getCommonDimen()), getCommonDimen().toFloat())
            }
        }
