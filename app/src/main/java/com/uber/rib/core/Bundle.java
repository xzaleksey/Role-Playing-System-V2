...
public class Bundle {
    ...
    /**
     * Returns a {@link com.uber.rib.core.Bundle} for a given key, or {@code null}.
     *
     * @param key to fetch.
     * @return a {@link com.uber.rib.core.Bundle} or {@code null}
     */
    @Nullable
    public com.uber.rib.core.Bundle getBundleExtra(String key) {
        Parcelable value = androidBundle.getParcelable(key);
        if (value != null) {
            return new com.uber.rib.core.Bundle((android.os.Bundle) value);
        } else {
            return null;
        }
    }
     ...
     */
    public void putBundleExtra(String key, @Nullable com.uber.rib.core.Bundle bundle) {
        if (bundle != null) {
