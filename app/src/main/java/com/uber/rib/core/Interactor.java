...
/**
 * The base implementation for all {@link com.uber.rib.core.Interactor}s.
 *
...
public abstract class Interactor<P, R extends Router>
    ...
    /**
     * Called when detached. The {@link com.uber.rib.core.Interactor} should do its cleanup here. Note: View will be
     * removed automatically so {@link com.uber.rib.core.Interactor} doesn't have to remove its view here.
     */
