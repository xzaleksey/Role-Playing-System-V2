...
public class RibRefWatcher {
    ...
    @Nullable
    private static com.uber.rib.core.RibRefWatcher instance;
    ...
    /**
     * Get an instance of the {@link com.uber.rib.core.RibRefWatcher}.
     *
     * @return the {@link com.uber.rib.core.RibRefWatcher} instance.
     */
    public static com.uber.rib.core.RibRefWatcher getInstance() {
        if (instance == null) {
            instance = new com.uber.rib.core.RibRefWatcher();
        }
        return instance;
    }
