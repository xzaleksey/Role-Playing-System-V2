...
public class Router<I extends com.uber.rib.core.Interactor, C extends InteractorBaseComponent> {
     ...
     * <p>
     * <p>If you have multiple children of the same class, use {@link com.uber.rib.core.Router#attachChild(com.uber.rib.core.Router,
     * String)} to specify a custom tag.
     *
     * @param childRouter the {@link com.uber.rib.core.Router} to be attached.
     */
    @MainThread
    protected void attachChild(com.uber.rib.core.Router<?, ?> childRouter) {
     ...
     */
    @MainThread
    protected void attachChild(com.uber.rib.core.Router<?, ?> childRouter, String tag) {
        for (com.uber.rib.core.Router child : children) {
     ...
     *
     * @param childRouter the {@link com.uber.rib.core.Router} to be detached.
     */
    @MainThread
    protected void detachChild(com.uber.rib.core.Router childRouter) {
    ...
    /**
     * Gets the children of this {@link com.uber.rib.core.Router}.
     *
     * @return Children.
     */
    public List<com.uber.rib.core.Router> getChildren() {
        return children;
    }
