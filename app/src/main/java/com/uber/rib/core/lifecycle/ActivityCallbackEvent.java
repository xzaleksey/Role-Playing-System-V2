...
public class ActivityCallbackEvent implements ActivityEvent {
    ...
    private static final com.uber.rib.core.lifecycle.ActivityCallbackEvent LOW_MEMORY_EVENT =
            new com.uber.rib.core.lifecycle.ActivityCallbackEvent(Type.LOW_MEMORY);
     ...
     */
    public static com.uber.rib.core.lifecycle.ActivityCallbackEvent.ActivityResult createOnActivityResultEvent(
     ...
     */
    public static com.uber.rib.core.lifecycle.ActivityCallbackEvent create(Type type) {
        switch (type) {
            case LOW_MEMORY:
     ...
     * @return the created ActivityEvent.
     */
    public static com.uber.rib.core.lifecycle.ActivityCallbackEvent createOnSaveInstanceStateEvent(@Nullable Bundle outState) {
        return new com.uber.rib.core.lifecycle.ActivityCallbackEvent.SaveInstanceState(outState);
    }
    ...
    /**
     * An {@link com.uber.rib.core.lifecycle.ActivityCallbackEvent} that encapsulates information from {@link
     * Activity#onActivityResult(int, int, Intent)}.
     */
    public static class ActivityResult extends com.uber.rib.core.lifecycle.ActivityCallbackEvent {
     ...
     */
    public static class SaveInstanceState extends com.uber.rib.core.lifecycle.ActivityCallbackEvent {
